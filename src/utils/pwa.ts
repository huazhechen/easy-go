...
export const PWA_OFFLINE_READY_EVENT = 'easy-go:pwa-offline-ready';
export const PWA_UPDATE_READY_EVENT = 'easy-go:pwa-update-ready';
export const PWA_INSTALL_DISMISSED_KEY = 'easy-go:pwa-install-dismissed:v1';
