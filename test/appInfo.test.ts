...
describe('app info', () => {
  it('builds GitHub commit URLs for real commit hashes', () => {
    expect(buildCommitUrl('abcdef1')).toBe('https://github.com/huazhechen/easy-go/commit/abcdef1');
    expect(buildCommitUrl('1234567890abcdef1234567890abcdef12345678')).toBe(
      'https://github.com/huazhechen/easy-go/commit/1234567890abcdef1234567890abcdef12345678'
    );
  });
