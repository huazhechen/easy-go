...
const LEGACY_STORAGE_KEY = 'easy-go:library:v1';
const MIGRATION_FLAG_KEY = 'easy-go:library_migrated_to_idb:v1';
const PRELOADED_VERSION_KEY = 'easy-go:library_preloaded_version:v1';
export const LIBRARY_CURRENT_FOLDER_STORAGE_KEY = 'easy-go:library_current_folder:v1';
const PRELOADED_VERSION = 3;
const PRELOADED_FOLDER_NAME = 'Famous Games';
const DB_NAME = 'easy-go-library';
const DB_VERSION = 1;
